...
describe("SocialContact", () => {
    describe("render", () => {
        it("renders the icon", () => {
            render(<SocialContact link="https://github.com/chicio" icon={<span data-testid="gh-icon">GitHub</span>} />);
            expect(screen.getByTestId("gh-icon")).toBeInTheDocument();
        });

        it("renders a link pointing to the correct href", () => {
            render(<SocialContact link="https://github.com/chicio" icon={<span>GH</span>} />);
    ...
    describe("interaction", () => {
        it("calls onClick when the link is clicked", async () => {
            const onClick = vi.fn();
            render(<SocialContact link="https://github.com/chicio" icon={<span>GH</span>} onClick={onClick} />);
