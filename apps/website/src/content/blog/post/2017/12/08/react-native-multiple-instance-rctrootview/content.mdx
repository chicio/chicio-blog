...
date: 2017-12-08
image: /media/content/blog/post/2017/12/08/react-native-multiple-instance-rctrootview/react-native-crash-reload-with-debugger.jpg
...
<Youtube videoId="HgSbUVlv1Oo" title="RCTRootView bug: duplicate dev menus and live reload refresh" />

* if we do a **live reload while we're in debug mode the app could crash**

![The react native app crashes if we try to do a live reload](/media/content/blog/post/2017/12/08/react-native-multiple-instance-rctrootview/react-native-crash-reload-with-debugger.jpg)
...
<Youtube videoId="z2gwLX8LaLQ" title="RCTRootView fix: shared bridge, single dev menu, no crash" />
