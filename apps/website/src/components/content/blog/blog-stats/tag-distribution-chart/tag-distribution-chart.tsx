...
export const TagDistributionChart: FC<TagDistributionChartProps> = ({ data }) => {
    ...
    return (
        <div className="w-full" style={{ height: chartHeight }}>
            <ResponsiveContainer width={"100%"} height={"100%"} initialDimension={{ width: 320, height: chartHeight }}>
                <BarChart data={data} layout="vertical">
                    ...
                    />
                    <Tooltip content={<ChartTooltip labelPrefix="Tag: " />} cursor={{ fill: chartTheme.cursorFill }} />
                    <Bar dataKey="count" name="Posts" fill="#00CC33" radius={[0, 6, 6, 0]} />
                </BarChart>
            </ResponsiveContainer>
        </div>
    );
