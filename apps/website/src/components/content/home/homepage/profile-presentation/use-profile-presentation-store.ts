...
export const useProfilePresentationStore = (): EffectsStore<ProfilePresentationEffects> => {
    const onTrackGithub = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_github,
    ...
    const onTrackLinkedin = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_linkedin,
                category: tracking.category.home,
                label: tracking.label.body,
            }),
        [],
    ...
    const onTrackMedium = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_medium,
                category: tracking.category.home,
                label: tracking.label.body,
            }),
        [],
    ...
    const onTrackDevto = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_devto,
                category: tracking.category.home,
                label: tracking.label.body,
            }),
        [],
    ...
    const onTrackTwitter = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_twitter,
                category: tracking.category.home,
                label: tracking.label.body,
            }),
        [],
    ...
    const onTrackFacebook = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_facebook,
                category: tracking.category.home,
                label: tracking.label.body,
            }),
        [],
    ...
    const onTrackInstagram = useCallback(
        () =>
            trackWith({
                action: tracking.action.open_instagram,
                category: tracking.category.home,
                label: tracking.label.body,
            }),
        [],
