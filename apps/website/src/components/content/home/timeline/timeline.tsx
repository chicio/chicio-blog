...
export const Timeline: FC = () => {
    const getIcon = (type: "work" | "education") => {
        return type === "work" ? <BiBriefcase className="size-5" /> : <BiSolidGraduation className="size-5" />;
    };

    return (
        <div className="relative my-9 flex max-w-[1400px] flex-col gap-4 py-4 md:gap-6 md:py-6">
            <span
            ...
            {timelineData.map((item) => (
                <div className="relative flex w-full flex-row gap-2 md:gap-4" key={item.id}>
