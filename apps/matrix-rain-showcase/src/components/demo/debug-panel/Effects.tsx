    ...
    return (
        <div className="rail-section">
            ...
            <Group title="Simulation" disabled={false}>
                <Slider label="density" min={0} max={1} step={0.01} value={density} onChange={onDensityChange} />
                <Slider label="stepRate (Hz)" min={1} max={60} step={1} value={stepRate} onChange={onStepRateChange} />
                <Slider label="fontSize (px)" min={8} max={40} step={1} value={fontSize} onChange={onFontSizeChange} />
            ...
            <Group title="Parallax" disabled={false}>
                ...
                />
                <Slider label="tail min" min={2} max={40} step={1} value={tailRange[0]} onChange={handleTailMin} />
                <Slider label="tail max" min={2} max={40} step={1} value={tailRange[1]} onChange={handleTailMax} />
                <Slider label="depthDim" min={0} max={1} step={0.05} value={depthDim} onChange={onDepthDimChange} />
            </Group>
