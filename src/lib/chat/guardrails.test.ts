...
describe("runGuardrails — prompt injection detection (synchronous patterns)", () => {
    beforeEach(() => {
        vi.clearAllMocks();
...
describe("runGuardrails — LLM safety gate (input safety check)", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
...
describe("runGuardrails — topic relevance gate", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
