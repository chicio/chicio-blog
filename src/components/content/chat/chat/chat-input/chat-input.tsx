...
export const ChatInput: FC<{
    ...
    <div className="container-fixed fixed right-0 bottom-0 left-0 z-50 p-3">
        <form className="flex w-full flex-row items-center justify-center gap-2" onSubmit={handleSubmit}>
            <InputField
