...
**Endpoint**: `https://fabrizioduroni.it/api/mcp`

## <ParagraphTitleWithIcon icon={<BiWrench className="text-accent text-2xl" />}>Available Tools</ParagraphTitleWithIcon>
...
Note the different key names: `"servers"` (not `"mcpServers"`) and `"type": "http"`.
...
3. Enter `https://fabrizioduroni.it/api/mcp`
