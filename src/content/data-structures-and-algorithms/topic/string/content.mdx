---
title: "Strings"
description: "Strings are fundamental data types serving as the foundation for text processing, pattern recognition, and encoding/decoding operations."
date: 2025-09-27
...
import { StringVisualization } from "@/components/content/data-structures-and-algorithms/components/string-visualization";
import { FrequencyMapChart } from "@/components/content/data-structures-and-algorithms/components/frequency-map-chart";
...
*[Rabin–Karp](https://en.wikipedia.org/wiki/Rabin–Karp_algorithm)*
	-	Uses [rolling hash](https://en.wikipedia.org/wiki/Rolling_hash) to compare substring hashes instead of characters.
	-	Average: $O(n + m)$
