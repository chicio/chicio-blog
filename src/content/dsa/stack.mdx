...
This is why monotonic stack solutions typically run in $O(n)$ time, making them a practical and elegant application of [amortized analysis](/data-structures-and-algorithms/time-and-space-complexity).
