...
description: "In the last weeks I worked with my colleague Felice Giovinazzo on a new feature for the refund process. Let’s see how we used pact to test a message-based interaction between two microservices with Pact"
date: 2021-11-05
image: /images/content/blog/post/2021/11/05/contract-testing-asynchronous-messaging-pact-junit-mockk/pact-mockk-message.jpg
...
![contract testing pact](/images/content/blog/post/2021/11/05/contract-testing-asynchronous-messaging-pact-junit-mockk/pact-contract-testing.jpg "Pact contract testing")
...
![pact broker](/images/content/blog/post/2021/11/05/contract-testing-asynchronous-messaging-pact-junit-mockk/pact-broker-homepage.jpg "Pact broker homepage")
...
![pact publish example](/images/content/blog/post/2021/11/05/contract-testing-asynchronous-messaging-pact-junit-mockk/pact-publish-example.jpg "Pact publish example")
...
![pact broker contract message example](/images/content/blog/post/2021/11/05/contract-testing-asynchronous-messaging-pact-junit-mockk/pact-broker-homepage.jpg "Our Pact broker contract message 
page")
