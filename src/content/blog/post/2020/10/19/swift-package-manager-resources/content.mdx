...
description: "Recently I upgraded my ID3TagEditor swift package to the latest Swift tools version (5.3). During the upgraded I discovered that now you can bundle resources with your Swift package. In this post I will show you how  you can do this, and also an interesting trick in order to be able to build a project as a Swift Package and as a standard project from Xcode."
date: 2020-10-19 
image: /images/content/blog/post/2020/10/19/swift-package-manager-resources/swiftpm-resources.jpg
...
![Now I can run my ID3TagEditor acceptance tests when I open it as a Swift package in Xcode](/images/content/blog/post/2020/10/19/swift-package-manager-resources/open-as-package-xcode-id3tageditor.jpg)
...
![The implementation of the PathLoader class for SwiftPM](/images/content/blog/post/2020/10/19/swift-package-manager-resources/path-loader-swiftpm.jpg)
![The implementation of the PathLoader class for Xcode](/images/content/blog/post/2020/10/19/swift-package-manager-resources/path-loader-xcode.jpg)
