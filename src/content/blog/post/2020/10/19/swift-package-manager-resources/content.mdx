...
date: 2020-10-19 
image: /media/content/blog/post/2020/10/19/swift-package-manager-resources/swiftpm-resources.jpg
...
![Now I can run my ID3TagEditor acceptance tests when I open it as a Swift package in Xcode](/media/content/blog/post/2020/10/19/swift-package-manager-resources/open-as-package-xcode-id3tageditor.jpg)
...
![The implementation of the PathLoader class for SwiftPM](/media/content/blog/post/2020/10/19/swift-package-manager-resources/path-loader-swiftpm.jpg)
![The implementation of the PathLoader class for Xcode](/media/content/blog/post/2020/10/19/swift-package-manager-resources/path-loader-xcode.jpg)
