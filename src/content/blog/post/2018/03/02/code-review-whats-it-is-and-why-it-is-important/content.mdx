...
date: 2018-03-02
image: /images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/01-technology-version-update.jpg
...
![Class diagram of my personal implementation of minesweeper](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/minesweeper-fabrizio.jpg)

This one describes Angelo's implementation.

![Class diagram of Angelo Sciarra implementation of minesweeper](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/minesweeper-angelo.jpg)
...
![Technology update from Java 1.5 to Java 1.8](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/01-technology-version-update.jpg)
...
![Functional improvements to the original class](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/03-functional-field.jpg)

![A new field class has been introduced to describe a list of fields](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/04-new-fields-class.jpg)
...
![Minesweeper class is now a stateless object](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/02-minesweeper-fields-as-parameter.jpg)
...
![A lightweight chain has been introduced for the row parsing](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/05-lightweight-chain.jpg)

![A new ParsingContext class keeps the current status of the parsing](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/07-parsing-status-become-parsing-content-lightweight.jpg)
...
![Constants should be at the top of the class](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/08-constants-beginning-of-file.jpg)

![A comment related to a team guideline](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/06-guidelines.jpg)
...
![An example of using meaningful names](/images/content/blog/post/2018/03/02/code-review-whats-it-is-and-why-it-is-important/10-rename-masker.jpg)
