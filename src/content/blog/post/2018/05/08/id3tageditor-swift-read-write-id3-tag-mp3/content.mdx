...
description: "The second of a short series of post in which I describe my two latest project: ID3TagEditor and Mp3ID3Tagger. In this post I will talk about ID3TagEditor framework."
date: 2018-05-08
image: /images/content/blog/post/2018/05/08/id3tageditor-swift-read-write-id3-tag-mp3/id3tageditor-logo.jpg
...
![The ID3TagEditor logo](/images/content/blog/post/2018/05/08/id3tageditor-swift-read-write-id3-tag-mp3/id3tageditor-logo.jpg)
...
![An ID3 tag example shown with an hex editor](/images/content/blog/post/2018/05/08/id3tageditor-swift-read-write-id3-tag-mp3/id3-tag-example.jpg)
...
![An ID3 tag header example](/images/content/blog/post/2018/05/08/id3tageditor-swift-read-write-id3-tag-mp3/id3-tag-header.jpg)
...
![An ID3 frame example](/images/content/blog/post/2018/05/08/id3tageditor-swift-read-write-id3-tag-mp3/id3-frame-example.jpg)
