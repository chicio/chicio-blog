...
date: 2018-02-08
image: /media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-bundle-url-provider-setup.jpg
...
![The react native bridge delegate still uses the localhost url to load the bundled JS](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-bridge-delegate-localhost.jpg)
...
![If you run the app with the localhost url above, you will receive an error](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-error-on-device-failed-bundle.jpg)
...
![Add the release bundler script as an Xcode phase](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-setup-bundler.jpg)
...
![The ReactNativeBridgeDelegate gets the JS url from RCTBundleURLProvider](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-bundle-url-provider-setup.jpg)

Now we can try to build an run again the app on a real device. As you can see now everything works as expected.

![Now the app works correctly on a real device](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-app-working-on-device.jpg)
...
![The react-native-xcode.sh script source code](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-ip-txt-generation.jpg)
...
![The react native source that reads the ip from the ip.txt file](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-my-local-ip.jpg)
...
![xip.io service](/media/content/blog/post/2018/02/08/react-native-debug-on-device-rctbundleurlprovider/react-native-xipio.jpg)
