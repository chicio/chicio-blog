...
date: 2018-04-03
image: /images/content/blog/post/2018/04/03/blender-tutorial-3-modeling-basics-part-1/blender-modeling-create-primitive-meshes.jpg
...
![How to create primitive meshes](/images/content/blog/post/2018/04/03/blender-tutorial-3-modeling-basics-part-1/blender-modeling-create-primitive-meshes.jpg)
...
![How to select edges, faces and vertices](/images/content/blog/post/2018/04/03/blender-tutorial-3-modeling-basics-part-1/blender-select-edges-faces-vertices.jpg)
...
![How to modify a mesh](/images/content/blog/post/2018/04/03/blender-tutorial-3-modeling-basics-part-1/blender-modified-mesh.jpg)
...
![Proportional editing](/images/content/blog/post/2018/04/03/blender-tutorial-3-modeling-basics-part-1/blender-modeling-proportional-editing.jpg)

Below you can find an example of two meshes modified with and without the proportional editing enable. It's easy to see
the difference.

![Two meshes modified with and without the proportional editing enable](/images/content/blog/post/2018/04/03/blender-tutorial-3-modeling-basics-part-1/blender-modeling-proportional-editing-example.jpg)
