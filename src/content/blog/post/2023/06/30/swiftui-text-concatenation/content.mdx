...
description: "Do you need a way to compose beautiful text with images and custom font like you are used with Attributed String. The Text component has everything we need to create some sort of 'attributed text' directly in SwiftUI. Let's go!!!"
date: 2023-06-12
image: /images/content/blog/post/2023/06/30/swiftui-text-concatenation/swiftui-five-stars.png
...
![The layout of the hotel widget](/images/content/blog/post/2023/06/30/swiftui-text-concatenation/swiftui-hotel-layout.png)
