...
It builds a manifest of the project context files (`CLAUDE.md`, `ARCHITECTURE.md`, the [Claude Code rules](https://code.claude.com/docs/en/memory) in `.claude/rules`) that will be passed to every dispatched agent.
