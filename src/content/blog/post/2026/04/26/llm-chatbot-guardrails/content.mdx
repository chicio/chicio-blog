...
- **"Do anything now" / "Jailbreak"**: References to well-known jailbreak prompts like [DAN (Do Anything Now)](https://arxiv.org/pdf/2308.03825).
...
The guardrails pipeline plugs into the Next.js API route for the chat. Just as a Here's how the route handler looks:
