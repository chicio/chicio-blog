...
date: 2025-03-17
image: /media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-featured.jpg
...
![iOS language and region settings](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-settings-ios.jpg)
...
!["Which Locale?" supported locales](/media/content/blog/post/2025/03/17/locale-ios-app-device/whichlocale-locales-supported.png)
...
!["Which Locale?" Info.plist](/media/content/blog/post/2025/03/17/locale-ios-app-device/whichlocale-development-region-show-language-menu.png)
...
![An example with the default locale set at device level, that matches the app locale](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-en-gb-country-gb.jpg)
...
![An example of dialect (language + region) selected as language and region that doesn't match the dialect one.](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-en-gb-country-italy.jpg)
...
![An example with language without dialect (no region specified in the language) an a region that combined with the language created an app supported locale](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-en-country-ie.jpg)
...
![An example with a language without dialect and a region that doesn't match in combination any locale supported by the app](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-en-generic-country-italy.jpg)
...
![An example of device locale not supported by the app, but with a second preferred language supported](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-fr-with-fallback-it-country-fr.jpg)
...
![An example with a device locale not supported by the app](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-fr-country-fr.jpg)
...
![An example with a device locale not supported by the app, but with a country supported by another locale in the app](/media/content/blog/post/2025/03/17/locale-ios-app-device/which-locale-fr-country-ch.jpg)
