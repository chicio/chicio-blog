...
date: 2017-12-08
image: /images/content/blog/post/2017/12/08/react-native-multiple-instance-rctrootview/react-native-crash-reload-with-debugger.jpg
...
<Youtube videoId="HgSbUVlv1Oo" />

* if we do a **live reload while we're in debug mode the app could crash**

![The react native app crashes if we try to do a live reload](/images/content/blog/post/2017/12/08/react-native-multiple-instance-rctrootview/react-native-crash-reload-with-debugger.jpg)
