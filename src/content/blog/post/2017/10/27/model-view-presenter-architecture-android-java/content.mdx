...
description: "In this post I will talk about the model view presenter architectural pattern and how it can improve your unit test and your TDD workflow when developing an Android application."
date: 2017-10-27
image: /images/content/blog/post/2017/10/27/model-view-presenter-architecture-android-java/mockup-model-view-presenter.jpg
...
![A mockup of the final app we will obtain at the end of this post](/images/content/blog/post/2017/10/27/model-view-presenter-architecture-android-java/mockup-model-view-presenter.jpg)
...
![Chuck Norris approves the Model View Presenter architectural pattern](/images/content/blog/post/2017/10/27/model-view-presenter-architecture-android-java/model-view-presenter-platforms.jpg)
