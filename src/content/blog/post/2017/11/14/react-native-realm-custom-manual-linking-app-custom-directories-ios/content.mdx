...
date: 2017-11-14
image: /images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-10-build-works.jpg
...
![The folders structure of the project used as example in this post](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-1-directories.jpg)
...
![The react-native link command fails to install the realm library](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-2-link-fails.jpg)
...
![Add the ReactRealm xcodeproj to the project](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-3-manual-link-step-1.jpg)
![Link the Realm static lib](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-3-manual-link-step-2.jpg)

Now you would expect that everything works fine but...

![The compilation fails with a complain about a header file missing](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-4-manual-link-fails.jpg)
...
![Add the RealmReact folder and the RealmJS xcodeproj to the project](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-5-custom-manual-link-step-1.jpg)

![Add libRealmJS and libGCDWebServers static libraries to the project](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-5-custom-manual-link-step-2.jpg)
...
![Add the header search paths that were setted in the RealmReact project](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-6-header-search-path.jpg)

Now if we try to compile our app we expect that everything works fine but...ERROR :warning::fire:!!! The build fails :
boom:!!!

![The C++ compiler gives an error when compiling the RealmReact source code](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-7-Cplusplus-error.jpg)
...
![Update the C++ language dialect and std library to C++14/11](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-8-Cplusplus-setup.jpg)
...
![Remove the all_load linker flag](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-9-all_load.jpg)
...
![The example app compilation is working as expected and you can try to launch it](/images/content/blog/post/2017/11/14/react-native-realm-custom-manual-linking-app-custom-directories-ios/react-native-realm-10-build-works.jpg)
