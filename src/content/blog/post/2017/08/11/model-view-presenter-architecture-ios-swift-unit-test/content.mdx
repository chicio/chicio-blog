...
description: "In this post I will talk about the model view presenter architectural pattern and how it can improve your unit test and your TDD workflow when developing an iOS application."
date: 2017-08-11
image: /images/content/blog/post/2017/08/11/model-view-presenter-architecture-ios-swift-unit-test/model-view-presenter-ios.jpg
...
![A mockup of the final app we will obtain at the end of this post](/images/content/blog/post/2017/08/11/model-view-presenter-architecture-ios-swift-unit-test/mockup-model-view-presenter.jpg)
...
![model view presenter: let's toast to Unit Tests!](/images/content/blog/post/2017/08/11/model-view-presenter-architecture-ios-swift-unit-test/model-view-presenter-ios.jpg)
