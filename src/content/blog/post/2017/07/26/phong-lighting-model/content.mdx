...
date: 2017-07-26
image: /images/content/blog/post/2017/07/26/phong-lighting-model/phong-example.png
...
light depends on the incident angle of the light with respect to the surface’s normal. The diffuse illumination $I_{\text{diffuse}}$ of 
a surface point is obtained by multiplying the diffuse surface constant $k_{\text{d}}$ with the
...
![An example model rendered using Phong model in Spectral BRDF explorer](/images/content/blog/post/2017/07/26/phong-lighting-model/phong-example.png)
