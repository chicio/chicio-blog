...
description: "A lot of mobile developer often complains that React Native is not Native, because it is missing some features. This is absolutely not true! In this blog post I will show you how I create a component with a custom background shape, similar to the one I did for a native component ome time ago"
date: 2024-03-02
image: /images/content/blog/post/2024/03/02/react-native-skia-svg-background-shape-text/daily-deals-featured.jpg
...
![The component on both platforms: iOS and Android](/images/content/blog/post/2024/03/02/react-native-skia-svg-background-shape-text/daily-deals-featured.jpg)

<Youtube videoId="96wofMjkyKc" />
