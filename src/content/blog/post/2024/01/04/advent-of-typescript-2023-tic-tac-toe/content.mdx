...
description: "Tic tac toe, another classical kata games you can find at a coding dojo. A game that is simple to implement with functions, variables etc. becomes a real challenge when you try to implement it using only types."
date: 2024-01-04
image: /images/content/blog/post/2024/01/04/advent-of-typescript-2023-tic-tac-toe/advent-of-typescript-tic-tac-toe.jpg
