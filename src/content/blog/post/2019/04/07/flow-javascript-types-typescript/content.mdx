...
date: 2019-04-07
image: /media/content/blog/post/2019/04/07/flow-javascript-types-typescript/flow.jpg
...
![An example of the error emitted by flow when the types check is executed](/media/content/blog/post/2019/04/07/flow-javascript-types-typescript/flow-error-module.jpg)
