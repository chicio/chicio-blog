...
- **test** job: `npm run test:coverage` — prints coverage summary and **gates on thresholds** (statements 91%, branches 84%, functions 88%, lines 92% over `src/lib/**` + `src/components/design-system/**`). Coverage below the floor fails CI.
