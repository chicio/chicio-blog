...
paths:
  ...
  - "apps/website/src/lib/rate-limit/**/*"
---

# API Route Conventions

## Chat API (`apps/website/src/app/api/chat/route.ts`)
...
- System prompt defined in `apps/website/src/lib/chat/llm-prompt.ts`
- Guardrails (`apps/website/src/lib/chat/guardrails.ts`) topic-relevance check uses Groq `openai/gpt-oss-20b` with
...
## Contact API (`apps/website/src/app/api/contact/route.ts`)
- Resend API for transactional emails
- Honeypot field for spam protection
- Rate limiting via Upstash Redis (IP-based, `apps/website/src/lib/rate-limit/rate-limit.ts`)
