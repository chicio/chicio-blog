const tokens = {
  ...
  "colors.backgroundLight": {
    "value": "#002200",
    "variable": "var(--colors-background-light)"
  },
  "colors.textAbovePrimary": {
    "value": "#000000",
    "variable": "var(--colors-text-above-primary)"
  },
  "colors.textPrimary": {
    "value": "#E8FFE8",
  ...
  "colors.boxShadowLight": {
    "value": "rgba(0, 255, 65, 0.3)",
    "variable": "var(--colors-box-shadow-light)"
  },
  "colors.divider": {
    "value": "#00CC33",
    "variable": "var(--colors-divider)"
  },
  "colors.confirm": {
    "value": "#ff2a2a",
    "variable": "var(--colors-confirm)"
  },
  "colors.undo": {
    "value": "#33aaff",
    "variable": "var(--colors-undo)"
  },
  "fontSizes.2xs": {
    "value": "0.5rem",
